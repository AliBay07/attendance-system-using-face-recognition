...
import AllLogFilters from "../components/AllLogFilters";
...
const Logs = () => {
  ...
  useEffect(() => {
    const getLogs = () => {
      setIsLoading(true);
      axios
        .get(`${process.env.REACT_APP_URL}/api/log/getFilteredLogs`, {
          headers: {
  ...
  const columns = [
    { field: "name", headerName: "Name" , headerClassName: "custom-header" },
    ...
    <div className="bg-blue">
      ...
      >
        ...
        <Box display="flex"  mb={2}>
          <AllLogFilters onFilterChange={handleFilterChange} />
        </Box>
